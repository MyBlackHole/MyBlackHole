...
![Logo](https://zorrozou.github.io/assets/img/logo.png)

Hi, I'm zorro.

[View My GitHub Profile](https://github.com/zorrozou)
...
memory.oom.group：默认值为0，值为1之后在内存超限发生oom的时候，会将整个cgroup内的所有进程都干掉，oom\_score\_adj设置为-1000的除外。
